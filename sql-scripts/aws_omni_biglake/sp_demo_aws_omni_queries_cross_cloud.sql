...
-- Show EXECUTION GRAPH when done.  We query 84 million rows and return 29 thousand rows from AWS.
WITH aws_data AS
(
  SELECT Vendor_Id, 
         Rate_Code_Id, 
