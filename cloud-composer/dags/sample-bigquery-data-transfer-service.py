...
# bq ls --transfer_config --transfer_location=us-west2 --format=json
# [{"name":"projects/55121552096/locations/us-west2/transferConfigs/6204b922-0000-2446-add8-089e08254a24","destinationDatasetId":"test_dataset_id","displayName":"Copy Public NYC Taxi Data","updateTime":"2022-01-31T15:41:06.120914Z","dataSourceId":"cross_region_copy","params":{"source_dataset_id":"new_york_taxi_trips","overwrite_destination_table":true,"source_project_id":"bigquery-public-data"},"userId":"-8510066568950052504","datasetRegion":"us-west2","emailPreferences":{},"scheduleOptions":{"disableAutoScheduling":true}}]
...
def list_data_transfers(project_id, region):
    ...
    # Parse return JSON
    #print(response.json())
    #{'transferConfigs': [{'name': 'projects/55121552096/locations/us-west2/transferConfigs/621e6e79-0000-26c5-8ed3-001a114471f4', 'destinationDatasetId': 'taxi_dataset_public_copy', 'displayName': 'Copy Public NYC Taxi Data', 'updateTime': '2022-01-31T17:53:22.824517Z', 'dataSourceId': 'cross_region_copy', 'params': {'source_dataset_id': 'new_york_taxi_trips', 'source_project_id': 'bigquery-public-data', 'overwrite_destination_table': True}, 'userId': '-8510066568950052504', 'datasetRegion': 'us-west2', 'emailPreferences': {}, 'scheduleOptions': {'disableAutoScheduling': True}}, {'name': 'projects/55121552096/locations/us-west2/transferConfigs/621ea667-0000-26c5-8ed3-001a114471f4', 'destinationDatasetId': 'taxi_dataset_public_copy', 'displayName': 'Copy Public NYC Taxi Data', 'updateTime': '2022-01-31T18:07:50.028629Z', 'dataSourceId': 'cross_region_copy', 'params': {'source_project_id': 'bigquery-public-data', 'source_dataset_id': 'new_york_taxi_trips', 'overwrite_destination_table': True}, 'userId': '-8510066568950052504', 'datasetRegion': 'us-west2', 'emailPreferences': {}, 'scheduleOptions': {'disableAutoScheduling': True}}]}
    transferConfigName = ""
