...
import os
import json
import data_analytics_agent.rest_api_helper as rest_api_helper # Assumed async now
import logging
import data_analytics_agent.caching_utils as caching_utils # Your updated caching module

logger = logging.getLogger(__name__)

@caching_utils.timed_cache(5 * 60) # Use the async-aware cache decorator
def get_bigquery_dataset_list() -> dict: # Marked as def
    """
