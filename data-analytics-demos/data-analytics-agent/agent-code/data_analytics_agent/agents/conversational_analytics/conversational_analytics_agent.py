...
import data_analytics_agent.tools.conversational_analytics.conversational_analytics_agent_tools as conversational_analytics_agent_tools
...
def get_conversational_analytics_agent():
    return LlmAgent(name="ConversationalAnalytics_Agent",
                             description="This agent is used manage and create Conversational Analytics API resources.",
                             instruction=conversational_analytics_agent_instruction,
                             global_instruction=global_instruction.global_protocol_instruction,
                             tools=[ bigquery_table_tools.get_bigquery_table_list,
                                     conversational_analytics_agent_tools.conversational_analytics_data_agent_list,
                                     conversational_analytics_agent_tools.conversational_analytics_data_agent_exists,
                                     conversational_analytics_agent_tools.conversational_analytics_data_agent_get,
                                     conversational_analytics_agent_tools.conversational_analytics_data_agent_create,
                                     conversational_analytics_agent_tools.conversational_analytics_data_agent_delete,
                                     conversational_analytics_agent_tools.create_conversational_analytics_data_agent,
                                   ],
