...
import data_analytics_agent.bigquery.run_bigquery_sql as bq_sql # Not directly used in this function, but kept for consistency
import logging
import os # Keep os import for os.getenv

logger = logging.getLogger(__name__)


def get_data_governance_for_table(dataset_id: str, table_name: str) -> dict: # Changed to def
    """
