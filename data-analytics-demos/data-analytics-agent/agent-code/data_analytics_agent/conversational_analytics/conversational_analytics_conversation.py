...
def conversational_analytics_data_agent_conversations_list() -> dict: # Changed to def
    """
...
def conversational_analytics_data_agent_conversations_get(conversation_id: str) -> dict: # Changed to def
    """
...
def conversational_analytics_data_agent_conversations_exists(conversation_id: str) -> dict: # Changed to def
    """
    ...
    list_result = conversational_analytics_data_agent_conversations_list() # Added await
...
def conversational_analytics_data_agent_conversations_create(data_agent_id: str, conversation_id: str) -> dict: # Changed to def
    """
    ...
    existence_check = conversational_analytics_data_agent_conversations_exists(conversation_id) # Added await
