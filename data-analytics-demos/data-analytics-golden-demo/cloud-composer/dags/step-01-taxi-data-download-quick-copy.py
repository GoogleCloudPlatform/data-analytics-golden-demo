...
#gsutil_copy_command   = "gcloud storage cp --recursive gs://data-analytics-golden-demo/raw-bucket/raw gs://{}/".format(raw_bucket_name)
gsutil_copy_command   = "gcloud storage cp --recursive gs://data-analytics-golden-demo/raw-bucket-v2/raw gs://{}/".format(raw_bucket_name)
