...
gsutil_copy_data="gcloud storage cp --recursive gs://data-analytics-golden-demo/rideshare-lakehouse-raw-bucket/rideshare_llm_export/v1/* gs://{}/rideshare_llm_export/".format(env_rideshare_lakehouse_raw_bucket)
gsutil_copy_audios="gcloud storage cp --recursive gs://data-analytics-golden-demo/rideshare-lakehouse-raw-bucket/rideshare_audios/v1/*.mp3 gs://{}/rideshare_audios/".format(env_rideshare_lakehouse_raw_bucket)
