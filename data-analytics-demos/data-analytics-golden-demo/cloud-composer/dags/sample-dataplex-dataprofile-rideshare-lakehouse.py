...
# airflow.contrib is removed in Airflow 3
...
with airflow.DAG('sample-dataplex-dataprofile-rideshare-lakehouse',
    ...
    dataplex_data_profile = BashOperator(
          task_id='bash_dataplex_dataprofile_ridehshare_lakehouse',
          bash_command='bash_dataplex_dataprofile_ridehshare_lakehouse.sh',
          params=params_list,
          dag=dag
      )
